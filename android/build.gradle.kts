...
// 🌟 FINAL FIX: Ab 'basic' reference ko resolve karne ke liye ise explicitly import kiya gaya hai
...
allprojects {
    repositories {
        ...
        maven {
            ...
            // 🚨 KTS SYNTAX FIX: authentication.create<BasicAuthentication>("basic")
